...
In this group activity, our team acted as "information detectives" on a virtual treasure hunt focused on information retrieval and evaluation skills. Each group member independently used the PSU Library databases to locate a scholarly article discussing the impact of information overload on decision-making, then we compiled our findings into a shared Microsoft OneDrive document with APA citations and brief summaries of what each member found.
